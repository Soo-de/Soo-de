...
| :--- | :--- | :--- |
| **[RepoFlow](https://github.com/Soo-de/RepoFlow)** | A developer tool that analyzes repositories to generate automated CI/CD pipeline configurations. | `Python` `FastAPI` `HTMX` `Docker` |
| **[Smart Bus Control System](https://github.com/Soo-de/Smart-Bus-Control-System)** | An end-to-end IoT system collecting environmental data and transmitting it via a mobile interface. | `ESP8266` `Raspberry Pi` `MQTT` `Flutter` |
